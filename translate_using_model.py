...
# MBART Model
mbart_tokenizer = AutoTokenizer.from_pretrained("facebook/mbart-large-50-many-to-many-mmt", cache_dir="./models/mbart")
mbart_model = AutoModelForSeq2SeqLM.from_pretrained("facebook/mbart-large-50-many-to-many-mmt", cache_dir="./models/mbart")

# MT5
mt5_en_fa_tokenizer = AutoTokenizer.from_pretrained("persiannlp/mt5-large-parsinlu-translation_en_fa", cache_dir="./models/mt5")
mt5_en_fa_model = AutoModelForSeq2SeqLM.from_pretrained("persiannlp/mt5-large-parsinlu-translation_en_fa", cache_dir="./models/mt5")

mt5_fa_en_tokenizer = AutoTokenizer.from_pretrained("persiannlp/mt5-base-parsinlu-opus-translation_fa_en", cache_dir="./models/mt5")
mt5_fa_en_model = AutoModelForSeq2SeqLM.from_pretrained("persiannlp/mt5-base-parsinlu-opus-translation_fa_en", cache_dir="./models/mt5")
